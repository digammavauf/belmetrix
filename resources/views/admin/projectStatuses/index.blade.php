...
@can('project_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'ProjectStatus', 'route' => 'admin.project-statuses.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.project-statuses.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  $('.datatable-ProjectStatus').DataTable(dtOverrideGlobals);
